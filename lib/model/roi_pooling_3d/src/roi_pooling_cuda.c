...
int roi_pooling_forward_cuda(int pooled_depth, int pooled_height, int pooled_width, float spatial_scale,
                        THCudaTensor * features, THCudaTensor * rois, THCudaTensor * output, THCudaIntTensor * argmax)
{
    ...
    ROIPoolForwardLaucher(
        data_flat, spatial_scale, num_rois, data_depth, data_height,
...
int roi_pooling_backward_cuda(int pooled_depth, int pooled_height, int pooled_width, float spatial_scale,
